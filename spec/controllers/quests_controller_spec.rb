...
RSpec.describe QuestsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      ...
      it "assigns @quest with errors" do
        post :create, params: { quest: invalid_attributes }
        expect(assigns(:quest)).to be_a_new(Quest)
      ...
      it "assigns @quests" do
        existing_quest = Quest.create!(title: "Existing")
        post :create, params: { quest: invalid_attributes }
        expect(assigns(:quests)).to include(existing_quest)
      end
      ...
      context "Turbo Stream format" do
        it "renders turbo stream with error" do
          post :create, params: { quest: invalid_attributes }, format: :turbo_stream
          expect(response.media_type).to eq("text/vnd.turbo-stream.html")
        end
      end
    end
